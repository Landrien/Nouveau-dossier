...
import enfant from '../../ASSETS/Images/enfant.png'
import burgers1 from '../../ASSETS/Images/burgers1.png'
    ...
    const getproductdatabyid = async () => {
        let temp = {
            ...
            "Data": [
                {
                    "ProductId": 1,
                    "ProductName": "Petite Faim",
                    "ProductDescription": "Petites, moyennes et grandes formules, duos à partager, desserts glacés",
                    "ProductImage": [
                        {
                            id: 1,
                            image: enfant
    ...
    return (
        <div className='productpage'>
            ...
            <div className='slidercont'>
                <ProductsSlider products={products} categoryname='Produits recherchés' />
            </div>
            <div className='slidercont'>
                <ProductsSlider products={products1} categoryname='Explorer plus' />
            </div>
            <Footer1 />
            <Footer2 />
        </div>
